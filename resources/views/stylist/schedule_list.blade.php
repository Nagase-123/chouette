...
<body>
  <div class="box_all">
    ...
    <table class="schedule_table_list">
      ...
      <form method="post" action="/stylist/schedule_delete_comp">
        @csrf
        ...
        <div class="bt">
          <button type="submit" class="sub_bt" id="submit" onclick="return alert_js()">削除</button>
        </div>
