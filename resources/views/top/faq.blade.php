...
<body>
	<div class="box_all">
		...
		<div id="QandA-1">
			...
			<dl>
				...
				<dd>美容師のご登録には事前の審査が必要となっております。<br>
					...
					<a href="{{ url('/contact')}}">お問い合わせフォームはこちら</a>
				</dd>

				<dt>予約をキャンセルしたいです</dt>
				<dd>ログイン後、【past reservations】へお進み頂くとご予約状況が確認いただけます。<br>
				...
				<dd>過去の予約履歴は、ログイン後【past reservations】にてご覧いただけます。<br>
		...
		<div class="dotted_line">
			<p class="msg_p1">上記をご確認いただいても問題が解決しない場合はこちら<br>
